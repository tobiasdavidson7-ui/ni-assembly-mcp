...
class FormSpec:
    ...
    blurb: str = ""  # one-line plain-language description for the homepage index (see `summary`
    # for the fuller, more technical description shown on the form page itself)
...
FORMS: tuple[FormSpec, ...] = (
    ...
    FormSpec("departments", "Executive departments", "Current NICS departments.", get_departments, REFERENCE,
             ...
             blurb="The NI Civil Service departments."),
    FormSpec("parties", "Political parties", "Parties currently represented.", get_parties, REFERENCE,
             ...
             blurb="Parties currently sitting in the Assembly."),
    FormSpec("party-groups", "All-Party Groups", "Current cross-party interest groups.",
             ...
             blurb="Cross-party groups formed around a shared interest."),
    FormSpec("organisations", "All organisations", "Every current organisation, combined.",
             ...
             blurb="Every department, party and committee, in one list."),
    FormSpec(
        "committees",
        "Committees",
        ...
        blurb="What committees exist and what each covers.",
    ),
    FormSpec("constituencies", "Constituencies", "The 18 Assembly constituencies.", get_constituencies, REFERENCE,
             ...
             blurb="The 18 Assembly constituencies."),
    # --- members -----------------------------------------------------------
    FormSpec(
        "members",
        "Search members (MLAs)",
        ...
        blurb="Find an MLA by name, area or party.",
    ),
    FormSpec(
        "member-detail",
        "Member profile",
        ...
        blurb="An MLA's roles, contact details and interests.",
    ),
    FormSpec(
        ...
        blurb="What financial interests an MLA has declared.",
    ),
    FormSpec(
        "ministerial-roles",
        "Ministerial roles",
        ...
        blurb="Who holds each ministerial post.",
    ),
    FormSpec(
        ...
        blurb="How many seats each party holds.",
    ),
    # --- questions -------------------------------------------------------
    FormSpec(
        "questions",
        ...
        blurb="Written and oral questions to ministers.",
    ),
    FormSpec(
        "question-detail",
        "Question detail",
        ...
        blurb="One question's full answer, in full.",
    ),
    ...
    FormSpec(
        ...
        blurb="Motions, amendments and statements tabled in the Chamber.",
    ),
    FormSpec(
        "business-diary",
        "Business diary",
        ...
        blurb="What's happening at the Assembly this week.",
    ),
    FormSpec(
        "divisions",
        ...
        blurb="How each member voted on a given issue.",
    ),
    FormSpec(
        "motion-context",
        "Motion context",
        ...
        blurb="A motion's tablers, amendments and Bill, in one place.",
    ),
    FormSpec(
    ...
    FormSpec(
        ...
        blurb="The Assembly's sitting days.",
    ),
    FormSpec(
        "debate-titles",
        ...
        blurb="Debates on a topic, by title.",
    ),
    FormSpec(
        ...
        blurb="Who talks most about a topic.",
    ),
    # --- committees ----------------------------------------------------
    FormSpec(
        "committee-agenda",
        ...
        blurb="What's on a committee's agenda.",
    ),
)
